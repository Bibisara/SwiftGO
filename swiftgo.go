...
import (
	...
	"github.com/bibisara/swiftgo/cache"
	"github.com/bibisara/swiftgo/mailer"
	"github.com/bibisara/swiftgo/render"
	"github.com/bibisara/swiftgo/session"
...
// SwiftGO is the overall type for the SwiftGO package. Members that are exported in this type
...
// New reads the .env file, creates our application config, populates the SwiftGO type with settings
// based on .env values, and creates necessary folders and files if they don't exist
func (s *SwiftGO) New(rootPath string) error {
...
func (s *SwiftGO) Init(p initPaths) error {
	root := p.rootPath
...
func (s *SwiftGO) checkDotEnv(path string) error {
...
func (s *SwiftGO) startLoggers() (*log.Logger, *log.Logger) {
...
func (s *SwiftGO) createMailer() mailer.Mail {
...
func (s *SwiftGO) createClientRedisCache() *cache.RedisCache {
...
func (s *SwiftGO) createClientBadgerCache() *cache.BadgerCache {
...
func (s *SwiftGO) createRedisPool() *redis.Pool {
	return &redis.Pool{
		MaxIdle:     50,
		MaxActive:   10000,
...
func (s *SwiftGO) createBadgerConn() *badger.DB {
...
func (s *SwiftGO) BuildDSN() string {
	var dsn string
...
func (s *SwiftGO) createFileSystems() map[string]interface{} {
